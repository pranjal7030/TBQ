...
public class Following extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getFollowings();//getting followings data
        ...
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent open=new Intent(Following.this,Following.class);
    ...
    private void getFollowings() {
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Followings").child(UserId);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChildren()) {
                    ...
                    mAdapter = new FollowAdapter(Following.this, mUploads);
