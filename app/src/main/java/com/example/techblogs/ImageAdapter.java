...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item_allblogs, parent, false);
       ...
       final Upload uploadCurrent = mUploads.get(position);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.equals(null) || dataSnapshot.hasChildren()) {
        ...
        public ImageViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    upload = mUploads.get(getAdapterPosition());

                    if (firebaseAuth.getCurrentUser().getUid().equals(upload.getUserId())) {
                        Intent show = new Intent(mContext, Activity_Show_Own_User_Data.class);
                        show.putExtra("userid", upload.getUserId());
                        show.putExtra("blogid", upload.getBlogId());
                        mContext.startActivity(show);
                    }

                    else if(!firebaseAuth.getCurrentUser().getUid().equals(upload.getUserId()))
                    {
