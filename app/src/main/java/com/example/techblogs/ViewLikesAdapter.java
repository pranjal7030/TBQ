...
import de.hdodenhof.circleimageview.CircleImageView;
    ...
    public class ViewLikesAdapter extends RecyclerView.Adapter<ViewLikesAdapter.ImageViewHolder>  {
        private List<Saved> uploads;
        private Context mContext;
        private ActivityFunctions activityFunctions = new ActivityFunctions(mContext);

        public ViewLikesAdapter( Context context,List<Saved> uploads) {
            mContext = context;
            this.uploads = uploads;
        }

        @Override
        public ViewLikesAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_followers_list, parent, false);
            return new ViewLikesAdapter.ImageViewHolder(v);
        }

        @Override
        public void onBindViewHolder(final ViewLikesAdapter.ImageViewHolder holder, int position) {
